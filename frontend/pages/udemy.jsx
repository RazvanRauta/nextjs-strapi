    ...
    <HeaderStyled>
      <div className="header">
        <TextBox>
          ...
          <Button animation="moveInBottom 500ms ease-out 750ms" fillMode="backwards">
            Discover more
          </Button>
        </TextBox>
      </div>
...
const Button = styled.a`
  color: ${(props) => (props.color ? props.color : props.theme.colors.text.primary)};
  background-color: ${(props) => (props.bg ? props.bg : props.theme.colors.backgrounds.white)};
